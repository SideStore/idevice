...
impl RpPairingFile {
    ...
    /// Returns true if this pairing file was not newly generated by idevice.
    pub fn is_paired(&self) -> bool {
        self.generated_by.as_deref() != Some("idevice")
    }
    ...
    pub fn generate(sending_host: &str) -> Self {
        ...
        Self {
            ...
            identifier,
            alt_irk: None,
            generated_by: Some("idevice".to_string()),
        }
    }
    ...
    pub(crate) fn recreate_signing_keys(&mut self) {
        ...
        self.alt_irk = None;
        self.generated_by = Some("idevice".to_string());
    }
    ...
    pub fn from_bytes(bytes: &[u8]) -> Result<Self, IdeviceError> {
        ...
        let generated_by = p.remove("generated_by").and_then(|x| x.into_string());
